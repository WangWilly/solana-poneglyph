...
export type Utils = {
  ...
  instructions: [
    ...
    {
      name: 'createTicketV1';
      discriminator: [170, 239, 208, 151, 5, 237, 231, 24];
      accounts: [
        {
          name: 'asset';
          writable: true;
        ...
        {
          name: 'systemProgram';
          docs: ["Must match the System Program's ID."];
          address: '11111111111111111111111111111111';
        },
        {
          name: 'mplCoreProgram';
    ...
    {
      name: 'transferTicket';
      discriminator: [191, 184, 74, 239, 164, 172, 188, 32];
      accounts: [
        {
          name: 'payer';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [103, 78, 131, 224, 69, 19, 162, 17];
      accounts: [
        {
          name: 'payer';
          writable: true;
